    ...
    <div className="p-3 space-y-3 anim-rise">
      ...
      <Panel title="NOTE">
        <p className="font-term text-dim text-base">
          ...
          Tommy always holds 90%. Custom sprite uploads are stubbed; names &amp; Tommy’s personality are live.
        </p>
      </Panel>

      <PixelButton variant="gold" className="w-full" onClick={() => useGameStore.getState().resolve()}>
        ✓ DONE
      </PixelButton>
    </div>
  )
